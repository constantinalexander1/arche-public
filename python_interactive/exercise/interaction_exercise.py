...
class StoryPoint:
    ...
    def __init__(self, id: int, question: str, options: List[Option], terminal: bool, won: bool = False):
        ...
        # "pass" sollst du löschen und durch die Speicherung der Parameter ersetzen.
        # TODO
        pass
...
def main():
    ...
    # Ersetze "None" durch die Liste der Storypoints.
    # TODO
    story_points = None
    ...
    while current_story_point is not None:
        ...
        # Speichere die ID in einer Variable next_story_point_id. Ersetze dafür "None" durch den Funktionsaufruf.
        # TODO
        next_story_point_id = None
        ...
        if next_story_point_id is not None:
            ...
            # Ersetze "None" durch den Funktionsaufruf.
            # TODO
