...
# AUFGABEN
# 1. GIBT DIE FRAGE EINES STORYPOINTS AUS
# 2. PRÜFE OB DER STORYPOINT EIN ENDPUNKT IST UND GIB DAS ERGEBNIS AUS
# 3. MACHE EINEN AUFRUF UM EINEN STORYPOINT AUSZUFÜHREN
# 4. IDENTIFIZIERE DEN NÄCHSTEN STORYPOINT
# 5. DENKE DIR SELBER EINE KURZE GESCHICHTE AUS UND ERSTELLE DIE NÖTIGEN STORYPOINTS

# FORTGESCHRITTENE AUFGABEN
# 6. SCHREIBE SELBST DIE get_story_point_by_id FUNKTION
# 7. VERSUCHE DEN TRY EXCEPT BLOCK ZU VERSTEHEN. WAS TUT ER UND WARUM IST ER NÜTZLICH?
...
class StoryPoint:
    ...
    def ask_question_let_user_choose_option_and_return_next_story_point_id(self):
        ...
        # TASK 1: GIB DIE FRAGE DES STORYPOINTS AUS
        # Du kannst etwas ausgeben mit der print()-Funktion.
        # Die Frage ist in der Variable self.question gespeichert.
        # SOLUTION:
        print(self.question)

        # TASK 2: PRÜFE OB DER STORYPOINT EIN ENDPUNKT IST UND GIB DAS ERGEBNIS AUS
        ...
        user_input = input()
        # TASK 7: VERSUCHE DEN TRY EXCEPT BLOCK ZU VERSTEHEN. WAS TUT ER UND WARUM IST ER NÜTZLICH?
        try:
...
def get_story_point_by_id(story_points: List[StoryPoint], story_point_id: int):
    ...
    # TASK 6: SCHREIBE SELBST DIE get_story_point_by_id FUNKTION
...
def main():
    ...
    # TASK 5: DENKE DIR SELBER EINE KURZE GESCHICHTE AUS UND ERSTELLE DIE NÖTIGEN STORYPOINTS
    ...
    while current_story_point is not None:
        # TASK 3: MACHE EINEN AUFRUF UM EINEN STORYPOINT AUSZUFÜHREN
        ...
        if next_story_point_id is not None:
            # TASK 4: IDENTIFIZIERE DEN NÄCHSTEN STORYPOINT
