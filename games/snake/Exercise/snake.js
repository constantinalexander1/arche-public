/*
	Inspired by https://github.com/vrana/games
	Modified (2023)
*/
 ...
 * 
 * AUFGABEN:
 *  - Hintergrund ändern (HTML)
 * 	- Schlange hinzufügen (JS + HTML (score card))
 * 	- Pause knopf hinzufügen (HTML + JS)
 *  - Neue Essens-Größe hinzufügen
 */
...
(function () {
	...
	for (var i = 0; i < 10; i++) {
		...
		var value = Math.floor(Math.random() * (3 - 1 + 1) + 1)
